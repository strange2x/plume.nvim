return {
	...
	vim.api.nvim_create_autocmd("LspAttach", {
		...
		callback = function(e)
			vim.keymap.set("n", "<leader>lds", builtin.lsp_document_symbols, {silent = true, desc = "[L]sp [D]ocument [S]ymbols"})
			vim.keymap.set("n", "<leader>lws", builtin.lsp_workspace_symbols, {silent = true, desc = "[L]sp [W]orkspace [S]ymbols"})
			vim.keymap.set("n", "gr", builtin.lsp_references, {silent = true, desc = "[L]sp Show References"})
		end
	})
